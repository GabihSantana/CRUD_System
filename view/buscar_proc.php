...
<br><br><br>
<main>
    <!--Form simples para procurar qual procedimento corresponde ao numero-->
    <a href="lista_agendamentos.php"><i class="material-icons prefix medium">keyboard_arrow_left</i></a>
    <br><br>
        <form action="bd_buscar_proc.php" method="get">
            <h4 class="center-align">Informe o código do procedimento:</h4>
